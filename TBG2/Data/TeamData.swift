...
class TeamModel {
    ...
    init() {
        ...
        let fixture1 = Fixture(time: "15:00", date: 20-10-2019, opposition: "Challengers FC", hosts: "Avonmouth FC", homeFixture: true, venue: "Old place")
        let fixture2 = Fixture(time: "17:00", date: 27-10-2019, opposition: "Bolltox FC", hosts: "Avonmouth FC", homeFixture: true, venue: "Old place")
        let fixture3 = Fixture(time: "15:00", date: 06-11-2019, opposition: "Assticit FC", hosts: "Avonmouth FC", homeFixture: false, venue: "Old place")
